...
print('\033[36mAn Script that print the predecessor and the successor of the input number\033[m')
print('\033[35m-#-\033[m' * 20)
n = int(input('Input a integer number: '))
print('''The predecessor of number {}{}{} is the number {}{}{} and the successor is 
